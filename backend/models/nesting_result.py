...
class NestingResult(Base):
    ...
    # ✅ NUOVO: Relazione con il batch
    batch_id = Column(Integer, ForeignKey("nesting_batches.id"), nullable=True, index=True,
                     doc="ID del batch di cui fa parte questo nesting")
    batch = relationship("NestingBatch", back_populates="nesting_results")
