...
Revision ID: 556018d2bc90
Revises: 
Create Date: 2025-05-24 18:25:22.055233
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('Preparazione', 'Laminazione', 'Attesa Cura', 'Cura', 'Finito', name='odl_status'), nullable=False),
    sa.Column('note', sa.Text(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('status', postgresql.ENUM('SCHEDULED', 'MANUAL', 'DONE', name='schedule_entry_status'), nullable=False),
