...
export default function ProduzioneAutoclavistaPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Carica solo ODL rilevanti per l'autoclavista (Attesa Cura e Cura)
  ...
  const handleStatusChange = async (odl: ODLResponse, newStatus: "Cura" | "Finito") => {
    setIsAdvancing(true)
    try {
      await odlApi.updateStatusAutoclavista(odl.id, newStatus)
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Link href="/dashboard/autoclavista/nesting">
